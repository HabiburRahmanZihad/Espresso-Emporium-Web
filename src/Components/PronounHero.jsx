...
const PronounHero = () => {
    return (
        <>
            <div className="bg-[url('/public/assets/more/10.png')] bg-cover bg-center bg-no-repeat">
                <div className='w-9/12 mx-auto grid grid-cols-2 md:grid-cols-4 gap-12 py-14'>
                    {/* Card 1 */}
                    <div className='space-y-6 '>
                        <img src="/public/assets/icons/1.png" alt="" />
                    ...
                    {/* Card 2 */}
                    <div className='space-y-6 '>
                        <img src="/public/assets/icons/2.png" alt="" />
                    ...
                    {/* Card 3 */}
                    <div className='space-y-6 '>
                        <img src="/public/assets/icons/3.png" alt="" />
                    ...
                    {/* Card 4 */}
                    <div className='space-y-6 '>
                        <img src="/public/assets/icons/4.png" alt="" />
